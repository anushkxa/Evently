...
public class Event extends BaseEntity{
    ...
    public Event(String eventName, UUID origanizerId,String organizerName, String organizerMobile,String city,EventCategory category,EventStatus status){
        this.eventName=eventName;
        this.organizerId=origanizerId;
        this.city=city;
